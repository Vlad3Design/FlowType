  ...
  async onload() {
    ...
    this.registerEvent(this.app.workspace.on("editor-menu", (menu, editor, view) => {
      if (editor.getSelection()) {
        menu.addSeparator();
        menu.addItem((item) => {
          item.setTitle("FlowType: Auto Capitalization").setIcon("wand").onClick(() => {
            this.applyAutoCapitalization(editor);
          });
        });
        menu.addItem((item) => {
          item.setTitle("FlowType: Smart Punctuation").setIcon("wand").onClick(() => {
            this.applySmartPunctuation(editor);
          });
        });
        menu.addItem((item) => {
          item.setTitle("FlowType: Smart Quotes").setIcon("wand").onClick(() => {
            this.applySmartQuotes(editor);
          });
        });
        menu.addItem((item) => {
          item.setTitle("FlowType: Number Formatting").setIcon("wand").onClick(() => {
            this.applyNumberFormatting(editor);
          });
        });
        menu.addItem((item) => {
